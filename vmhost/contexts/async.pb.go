...
import (
	...
	vmhost "github.com/DharitriOne/drt-chain-vm-go/vmhost"
	io "io"
	math "math"
	math_big "math/big"
	math_bits "math/bits"
...
type SerializableVMOutput struct {
	...
	GasRefund       *math_big.Int                         `protobuf:"bytes,5,opt,name=GasRefund,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"Value"`
...
type SerializableOutputAccount struct {
	...
	Balance             *math_big.Int                         `protobuf:"bytes,3,opt,name=Balance,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"Balance"`
	...
	BalanceDelta        *math_big.Int                         `protobuf:"bytes,8,opt,name=BalanceDelta,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"BalanceDelta"`
