...
import (
	...
	"github.com/DharitriOne/drt-chain-vm-go/crypto"
	"github.com/DharitriOne/drt-chain-vm-go/crypto/factory"
...
// allFlags must have all flags used by drt-chain-vm-go in the current version
